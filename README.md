...
> 파이썬을 처음 접하는 분을 위한 안내입니다. 이 프로그램을 사용하기 위해 파이썬을 깊게 공부할 필요는 없으며, 아예 몰라도 가능합니다. 다만, 생소한 프로그램으로 인해 설치과정이 다소 복잡하게 느껴질 수 있습니다. 그러나 설치만 완료하면 짜놓은 코드를 바로 사용할 수 있으니, 조금 힘들 수 있는점 감안하시고 아래 안내를 차근차근 따라와 주세요. 설치만 하면 다 끝난 것입니다(아마도).     
