...
> 이 부분은 파이썬을 처음 접하는 분을 위한 안내 글입니다. 그러니 사용이 익숙하신 분은 패스하시면 되겠습니다. 이 프로그램을 사용하기 위해 파이썬을 체계적으로 공부할 필요는 없으며 전혀 몰라도 사용이 가능합니다. 프로그램만 설치하면 사용이 가능하기에 아래에 가급적 상세히 기술하였으니 따라해 보시기를 권합니다.   
